...
if(totalIncome > 32,333	){
  ...
  nssfDeduction = 360;
    ...
    document.getElementById("payeeTax").innerHTML= payeeTax;
    document.getElementById("nhifDeduction").innerHTML = nhifDeduction;
    document.getElementById("nssfDeduction").innerHTML= nssfDeduction;
